        ...
        <BookInfo>
              ...
              {bookFormData.quotes.slice(0, 2).map((quote, index) => (
                <QuoteItem key={index}>
                  ...
                  <span style={{ fontSize: "11px", color: "#999" }}>
                    p.{addCommas(quote.page.toString())}
                  </span>
                </QuoteItem>
              ))}
            </div>
          ...
          {bookFormData.totalPages && (
            <p style={{ margin: "8px 0", fontSize: "12px", color: "#999" }}>
              총 {addCommas(bookFormData.totalPages.toString())}페이지
            </p>
          )}
          ...
          {bookFormData.share && (
            <div
              ...
              공유 설정:
              {bookFormData.share === "public"
                ? "전체 공개"
                : bookFormData.share === "follower"
                ? "팔로워만"
                : bookFormData.share === "private"
                ? "비공개"
                : ""}
            </div>
          )}
